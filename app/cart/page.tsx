      ...
      <div className="mt-8 grid gap-8 lg:grid-cols-3">
        ...
        <div className="h-fit border border-cream-200 bg-white p-6">
          ...
          <div className="mt-6 space-y-3">
            <Link
              href="/checkout"
              className="flex w-full items-center justify-center gap-2 bg-brand-900 py-4 text-sm font-semibold uppercase tracking-widest text-white transition-colors hover:bg-brand-700 active:scale-[0.98]"
            >
              Proceed to Checkout →
            </Link>
          </div>
